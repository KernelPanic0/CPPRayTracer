...
UI::UI(std::shared_ptr<Window> &pWindow) : pWindow(pWindow) {
...
void UI::Render(ImTextureID texture, std::unique_ptr<ActiveRenderer> &pRenderer, WorldData &pWorld) {
    ...
    if (Settings::uiVisible) {
        ...
        ImageViewer::DrawCanvas(canvas_size, texture, pRenderer->camParams.imageWidth, pRenderer->camParams.imageHeight);
        ImGui::EndChild();
